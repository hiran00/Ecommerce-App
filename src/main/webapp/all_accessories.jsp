...
<h2 class="text-center pt-5 fw-bold">ACCESSORIES</h2>
<p class="text-center pb-5">Latest Mobile Accessories Prices in Sri Lanka</p>
	<div class="row">		
			
			<%
			ProductsDAOImpl dao = new ProductsDAOImpl(DBConnect.getConn());
			List<Products> list =dao.getAllAccessories();
			for (Products p : list) {
			%> 
