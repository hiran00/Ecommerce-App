			...
			<div class=col-md-3>
				<div class="card crd-ho mb-4">
  					<div class="card-body text-center">	
	    	 			...
	    	 			<%
						String selectedCategory = request.getParameter("pcategory");
						
						if (selectedCategory != null && selectedCategory.equals("samsung")) {
						%>
						<a href="samsung_details.jsp?pid=<%=p.getpId() %>" class="btn btn-success btn-sm mb-2">View Details</a>
						<%
						} else if (selectedCategory != null && selectedCategory.equals("apple")) {
						%>
