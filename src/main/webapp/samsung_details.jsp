...
<%@include file="common_files/header.jsp"%>
	...
	<div>
		<div class="container">
			<div class="row">
				...
				<h2><%=p.getPname()%></h2>
				<p>
				Brand: <a href="all_samsung.jsp" style="text-decoration: none; " >Samsung</a><br>
				...
				<h6>WARRANTY :</h6>
				<p>01 YEAR SOFTWARE WARRANTY / DIRECT IMPORT / BRAND NEW / SEALED PACK / ORIGINAL / NON TRCSL APPROVED.
				<br><br> 
	...
	<div>
  		<div class="container py-5">
			...
			List<Products> list2 =dao2.getSamsung();
			...
			<div class=col-md-3>
				<div class="card crd-ho">
  					<div class="card-body text-center">	
	    			 	...
	    			 	<a href="samsung_details.jsp?pid=<%=p2.getpId() %>" class="btn btn-success btn-sm mb-2">View Details</a>
  					</div>
				</div>
			</div>
			<%
